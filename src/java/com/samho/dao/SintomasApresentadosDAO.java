 ...
 * 
 */
public class SintomasApresentadosDAO extends ObjetoDAO implements InterfaceDAO {

    public SintomasApresentadosDAO() {
        super("SINTOMAS_APRESENTADOS");
    }

    public int getProximoID() {
        return super.getProximoID("id_sintoma_apresentado");
    }
}
