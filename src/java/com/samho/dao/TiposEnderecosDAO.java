 ...
 * 
 */
public class TiposEnderecosDAO extends ObjetoDAO implements InterfaceDAO {

    public TiposEnderecosDAO() {
        super("TIPOS_ENDERECOS");
    }

    public int getProximoID() {
        return super.getProximoID("id_tipo_endereco");
    }
}
