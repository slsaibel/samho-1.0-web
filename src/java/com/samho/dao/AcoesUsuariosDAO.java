 ...
 * 
 */
public class AcoesUsuariosDAO extends ObjetoDAO implements InterfaceDAO {

    public AcoesUsuariosDAO() {
        super("ACOES_USUARIOS");
    }

    public int getProximoID() {
        return super.getProximoID("id_acao_usuario");
    }
