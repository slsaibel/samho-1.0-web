 ...
 * 
 */
public class SituacoesFuncionariosDAO extends ObjetoDAO implements InterfaceDAO {

    public SituacoesFuncionariosDAO() {
        super("SITUACOES_FUNCIONARIOS");
    }

    public int getProximoID() {
        return super.getProximoID("id_situacao");
    }
}
