 ...
 * 
 */
public class TiposTelefonesDAO extends ObjetoDAO implements InterfaceDAO {

    public TiposTelefonesDAO() {
        super("TIPOS_TELEFONES");
    }

    public int getProximoID() {
        return super.getProximoID("id_tipo_telefone");
    }
}
