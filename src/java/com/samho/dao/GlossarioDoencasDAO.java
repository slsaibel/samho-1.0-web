 ...
 * 
 */
public class GlossarioDoencasDAO extends ObjetoDAO implements InterfaceDAO {

    public GlossarioDoencasDAO() {
        super("GLOSSARIO_DOENCAS");
    }

    public int getProximoID() {
        return super.getProximoID("id_glossario_doenca");
    }
}
